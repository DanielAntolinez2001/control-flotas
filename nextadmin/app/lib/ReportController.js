...
export const createReport = async (id) => {
    try {
      ...
      if ( reportM == null){
        ...
        const maintenance = await maintenanceController.getMaintenanceForReport(id);
        ...
        const fluidSystem = await prisma.fluidsSystem.findMany({where: { truckId: maintenance.truck.id },})
        ...
        const bodyChassis = await prisma.bodyChassis.findMany({where: { truckId: maintenance.truck.id },})
        ...
        const electricalSystem = await prisma.electricalSystem.findMany({where: { truckId: maintenance.truck.id },})
        ...
        const brakes = await prisma.brakes.findMany({where: { truckId: maintenance.truck.id },})
        ...
        const fuel = await prisma.fuel.findMany({where: { truckId: maintenance.truck.id },})
        ...
        const exhaustSystem = await prisma.exhaustSystem.findMany({where: { truckId: maintenance.truck.id },})
        ...
        const tire = await prisma.tire.findMany({where: { truckId: maintenance.truck.id },})
        ...
        const report = await prisma.report.create({ data: { maintenanceId: id, content: reportContent, cost: costo, }, });
...
export const createReportFuel = async () => {
  try {
    ...
    const reportS = await prisma.report.findMany({ where: { consume_fuel: true } });
...
export const getReportByMaintenance = async (id) => {
  try {
    const report = await prisma.report.findMany({ where: { maintenanceId: id } });
