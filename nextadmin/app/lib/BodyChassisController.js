...
export const updateBodyChassis = async (req, id) => {
  ...
  try {
    const updateData = {};
    if (chassis_condition != "option")
      updateData.chassis_condition = chassis_condition;
    if (body_condition != "option") updateData.body_condition = body_condition;
    if (seatbelt_functionality != "option")
      updateData.seatbelt_functionality = seatbelt_functionality;
