      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        ...
        <div className={styles.address}>
          ...
          <input
            ...
            name="street"
            onChange={handleChange}
            placeholder={user.address ? user.address.street : "..."}
          />
          <label>State</label>
          <select
            name="state"
          ...
          <input
            ...
            name="neighborhood"
            onChange={handleChange}
            placeholder={user.address ? user.address.neighborhood : "..."}
          />
          ...
          <input
            ...
            name="zip_code"
            onChange={handleChange}
            placeholder={user.address ? user.address.zip_code : "..."}
          />
          <label>Details</label>
          <input
            type="text"
            name="details"
            onChange={handleChange}
            placeholder={user.address ? user.address.details : "..."}
          />
        </div>
        <div className={styles.section}>
